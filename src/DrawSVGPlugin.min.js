...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function () {
	...
	var e, t = _gsScope.document, p = t.defaultView ? t.defaultView.getComputedStyle : function () {
		...
		g = {rect: ["width", "height"], circle: ["r", "r"], ellipse: ["rx", "ry"], line: ["x2", "y2"]},
		C = "DrawSVGPlugin", m = String.fromCharCode(103, 114, 101, 101, 110, 115, 111, 99, 107, 46, 99, 111, 109),
	...
	function y(e) {
		if (!e) return 0;
		var t, r, i, o, s, n, a, h = (e = c(e)).tagName.toLowerCase(), f = 1, d = 1;
	...
	function x(e, t) {
		if (!e) return [0, 0];
		e = c(e), t = t || y(e) + 1;
		var r = p(e), i = r.strokeDasharray || "", o = parseFloat(r.strokeDashoffset), s = i.indexOf(",");
	...
	"undefined" != typeof module && module.exports ? (require(/*"../TweenLite.js"*/ 'gsap/TweenLite'), module.exports = t()) : "function" == typeof define && define.amd && define(["TweenLite"], t)
}();
